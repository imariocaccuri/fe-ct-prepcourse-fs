...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
      ...
      agregar = agregar + arrayOfNums[index]
   }
   return agregar;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   for (let index = 0; index < resultadosTest.length; index++) {
      promedios=promedios + resultadosTest[index]
      }
   var promedio= promedios / resultadosTest.length
   return promedio;
}
